...
model = dict(
    ...
    distill = dict(
        ...
        distill_reg_weight=1.,

        distill_fpn_type='nomask', # foreground / frs / valid / nomask / none
        distill_logits_type='nomask', # foreground / frs / None
        distill_reg_type='nomask', # foreground, frs && foreground, nomask
