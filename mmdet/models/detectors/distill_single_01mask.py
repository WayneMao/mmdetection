...
class Distilling_Single_01Mask(SingleStageDetector):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 distill=None,):
        super(Distilling_Single_01Mask, self).__init__(backbone, neck, bbox_head, train_cfg,
                                  test_cfg, pretrained)
        from mmdet.apis.inference import init_detector
    ...
    def forward_train(self,
        ...
        for layer in range(layers):
            ...
            # mask = mask.detach()
            # random 0,1 mask
            mask = torch.randint(2, (n,h,w), device=self.device) * 1.
