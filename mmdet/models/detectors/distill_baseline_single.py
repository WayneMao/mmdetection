...
class Distilling_Baseline_Single(SingleStageDetector):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 distill=None,):
        super(Distilling_Baseline_Single, self).__init__(backbone, neck, bbox_head, train_cfg,
                                  test_cfg, pretrained)
        from mmdet.apis.inference import init_detector
    ...
    def forward_train(self,
        ...
        for layer in range(layers):
            ...
            distill_cls_loss += cls_loss.mean()
